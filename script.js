...
const produtos = [
    new Produto("PROD001", "Notebook NovaBook Pro", "Informática", 3299.90, 5, "quadradobranco.png"),
    new Produto("PROD002", "Teclado Mecânico RGB", "Acessórios", 349.90, 8, "quadradobranco.png"),
    new Produto("PROD003", "Mouse Gamer Pulse", "Games", 189.90, 12, "quadradobranco.png"),
    new Produto("PROD004", "Headset SoundMax", "Games", 429.90, 3, "quadradobranco.png"),
    new Produto("PROD005", "Monitor UltraView 27\"", "Informática", 1399.90, 2, "quadradobranco.png"),
    new Produto("PROD006", "Webcam Vision HD", "Acessórios", 249.90, 0, "quadradobranco.png"),
    new Produto("PROD007", "Controle GamePad X", "Games", 299.90, 6, "quadradobranco.png"),
    new Produto("PROD008", "SSD Flash 1TB", "Informática", 499.90, 7, "quadradobranco.png")
];
